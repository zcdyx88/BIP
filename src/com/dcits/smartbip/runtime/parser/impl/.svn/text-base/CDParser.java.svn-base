...
import com.dcits.smartbip.runtime.parser.IParser;
...
/**
 * Created by vincentfxz on 16/7/21.
 */
public class CDParser implements IParser {

    private static final Log log = LogFactory.getLog(CDParser.class);
