...
public class kaneizhuandResetSigningCode extends AbstractBaseService implements IService{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2403372814387500271L;
	private static final Log log = LogFactory.getLog(kaneizhuandResetSigningCode.class);

	@Override
	public String getId() {
		return "kaneizhuandResetSigningCode";
	}
	...
	public Object execute(Object req) throws InvokeException {
		...
		if (log.isInfoEnabled()) {
			log.info("开始调用基础服务[kaneizhuandResetSigningCode]......");
		}
		...
		if (log.isInfoEnabled()) {
			log.info("调用基础服务结束[kaneizhuandResetSigningCode]......");
		}
