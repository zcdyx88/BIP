 ...
 *
 */
public class CropChangeSign_ECIF_Deal extends AbstractBaseService implements IService {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -4121613444975044655L;
	private static final Log log = LogFactory.getLog(CropChangeSign_ECIF_Deal.class);
	...
	@Override
	public String getId() {
		return "CropChangeSign_ECIF_Deal";
	}
	...
	public Object execute(Object req) throws InvokeException {
		...
		if (log.isInfoEnabled()) {
			log.info("开始调用基础服务[CropChangeSign_ECIF_Deal]......");
		}
		//服务码
		...
		if (log.isInfoEnabled()) {
			log.info("调用基础服务结束[CropChangeSign_ECIF_Deal]......");
		}
