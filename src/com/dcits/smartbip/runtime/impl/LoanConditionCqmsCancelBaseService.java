 ...
 * 
 */
public class LoanConditionCqmsCancelBaseService extends AbstractBaseService
		implements IService {
	private static final Log log = LogFactory
			.getLog(LoanConditionCqmsCancelBaseService.class);
	private static final long serialVersionUID = 1L;

	@Override
	public String getId() {
		return "LoanConditionCqmsCancelBaseService";
	}
	...
	public Object execute(Object req) throws InvokeException {
		...
		if (log.isInfoEnabled()) {
			log.info("开始调用基础服务[LoanConditionCqmsCancelBaseService]......");
		}
		...
		if (log.isInfoEnabled()) {
			log.info("调用基础服务结束[LoanConditionCqmsCancelBaseService]......");
		}
		return null;
