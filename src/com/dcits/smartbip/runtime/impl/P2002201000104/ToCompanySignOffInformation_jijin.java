...
public class ToCompanySignOffInformation_jijin extends AbstractBaseService implements IService{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6757929211668882607L;
	private static final Log log = LogFactory.getLog(ToCompanySignOffInformation_jijin.class);
	...
	@Override
	public String getId() {
		return "ToCompanySignOffInformation_jijin";
	}
	...
	public Object execute(Object req) throws InvokeException {
		...
		if (log.isInfoEnabled()) {
			log.info("开始调用基础服务[ToCompanySignOffInformation_jijin]......");
		}
		...
		if("true".equalsIgnoreCase((String) SessionContext.getContext().getValue("JijduigjieyLastSigningAcct"))){
			rspService = (ICompositeData) SessionContext.getContext().getValue("Rsp3005200000110"); 
		}else if ("false".equalsIgnoreCase((String) SessionContext.getContext().getValue("JijduigjieyLastSigningAcct"))){
			rspService = (ICompositeData) SessionContext.getContext().getValue("Rsp3005200000108");
		}
		...
		{
			log.info("000020"+"_"+"基金"+"解约成功，返回码="+retCode);
		} else 
		{
			log.info("产品代码="+"000020"+"_"+"基金"+"解约失败，返回码="+retCode+"服务码="+rspService.toString().substring(4)); 
			...
			CompositeDataUtils.setValue(arrayiItem, "SignOffProTp", "000020");
			CompositeDataUtils.setValue(arrayiItem, "SignOffProNm", "基金");
		}
		
		if (log.isInfoEnabled()) {
			log.info("调用基础服务结束[ToCompanySignOffInformation_jijin]......");
		}
