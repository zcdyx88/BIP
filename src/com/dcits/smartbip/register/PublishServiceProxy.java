...
public class PublishServiceProxy implements PublishServiceMBean {
    ...
    public String pubBuzzService(String ip, int regPort, int rmtPort, String id, String protocolType, String retCode,
                                 String namespace, String reversalServiceId, String wsdl, String serviceSchema, List<String> metadataSchema) {
        PublishBuzzServiceDataBean bean = new PublishBuzzServiceDataBean(id, protocolType, retCode,
                namespace, reversalServiceId, wsdl, serviceSchema, metadataSchema);
        return getMBean(ip, rmtPort, regPort).pubBuzzService(bean);
    }

    public String pubCompositeService(String ip, int regPort, int rmtPort, String serviceId, String serviceName,
                                      String serviceDesc, String processContent) {
        PublishCompositeServiceDataBean bean = new PublishCompositeServiceDataBean(serviceId, serviceName, serviceDesc, processContent, processContent, processContent, processContent, null);
